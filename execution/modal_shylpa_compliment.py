...
image = modal.Image.debian_slim().pip_install("whatsapp-api-client-python")

# Define the app
app = modal.App("shylpa-compliment")
...
COMPLIMENTS = [
    ...
    "Your flake is beautiful.", "Your season is beautiful.",
    "Your change is beautiful.", "Your moment is beautiful.",
    "Your stillness is beautiful.", "Your memory is beautiful.",
    "Your trace is beautiful.", "Your hope is beautiful.",
    "Your wish is beautiful.", "Your dream is beautiful.",
    "Your sleep is beautiful.", "Your wake is beautiful.",
    "Your morning is beautiful.", "Your noon is beautiful.",
    "Your evening is beautiful.", "Your night is beautiful.",
    "Your moon is beautiful.", "Your star is beautiful.",
    "Your constellation is beautiful.", "Your galaxy is beautiful.",
    "Your space is beautiful.", "Your planet is beautiful.",
    "Your world is beautiful.", "Your atmosphere is beautiful.",
    "Your air is beautiful.", "Your gravity is beautiful.",
    "Your pull is beautiful.", "Your energy is beautiful.",
    "Your vibration is beautiful.", "Your frequency is beautiful.",
    "Your signal is beautiful.", "Your echo is beautiful.",
    "Your bounce is beautiful.", "Your mirror is beautiful.",
    "Your reflection is beautiful.", "Your shadow is beautiful.",
    "Your dark is beautiful.", "Your light is beautiful.",
    "Your bright is beautiful.", "Your contrast is beautiful.",
    "Your balance is beautiful.", "Your harmony is beautiful.",
    "Your tune is beautiful.", "Your beat is beautiful.",
    "Your pulse is beautiful.", "Your heart is beautiful.",
    "Your beat is beautiful.", "Your breath is beautiful.",
    "Your life is beautiful.", "Your step is beautiful.",
    "Your path is beautiful.", "Your journey is beautiful.",
    "Your destination is beautiful.", "Your arrival is beautiful.",
    "Your welcome is beautiful.", "Your stay is beautiful.",
    "Your comfort is beautiful.", "Your home is beautiful.",
    "Your warmth is beautiful.", "Your safety is beautiful.",
    "Your shield is beautiful.", "Your sword is beautiful.",
    "Your fight is beautiful.", "Your peace is beautiful.",
...
@app.function(
    ...
    secrets=[
        modal.Secret.from_dict({
            "GREENAPI_ID_INSTANCE": "7105483931",
            "GREENAPI_API_TOKEN": "b2ecc4d2078344adbe70b2b6aad9a410b46f378cdb0345eb91"
        })
    ],
    schedule=modal.Cron("05 0 * * *") # 5:35 AM IST
)
def send_compliment():
    from whatsapp_api_client_python.API import GreenApi
    
    id_instance = os.environ["GREENAPI_ID_INSTANCE"]
    ...
    print(f"Sending compliment to {target_id}: {message}")
    
    response = client.sending.sendMessage(chatId=target_id, message=message)
    
    if response.code == 200:
        print(f"SUCCESS: {response.data}")
    else:
        print(f"ERROR {response.code}: {response.data}")

if __name__ == "__main__":
    with modal.enable_output():
        with app.run():
            send_compliment.remote()
